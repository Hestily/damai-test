...
.method public final computeWindowBoundsIceCreamSandwich$window_release(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    .line 4
    invoke-static {v0}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Point;->getx(Landroid/graphics/Point;)I

    move-result v2

    if-eqz v2, :cond_1

    invoke-static {v0}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Point;->gety(Landroid/graphics/Point;)I
...
.method public final computeWindowBoundsN$window_release(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-static {v1}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Point;->gety(Landroid/graphics/Point;)I
    ...
    invoke-static {v1}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Point;->getx(Landroid/graphics/Point;)I
...
.method public final computeWindowBoundsP$window_release(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-static {v3}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Point;->gety(Landroid/graphics/Point;)I
    ...
    invoke-static {v3}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Point;->getx(Landroid/graphics/Point;)I
    ...
    :cond_5
    :goto_1
    invoke-static {v0}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Rect;->width(Landroid/graphics/Rect;)I
    ...
    invoke-static {v0}, Lcom/alibaba/wireless/security/aopsdk/replace/android/graphics/Rect;->height(Landroid/graphics/Rect;)I
