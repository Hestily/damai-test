...
.method constructor <init>(Lokio/BufferedSource;Z)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/b$a;-><init>(ILokio/Source;)V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->d:Lokhttp3/internal/http2/b$a;
...
.method static a(IBS)I
    ...
    invoke-static {p0, p1}, Lokhttp3/internal/http2/c;->d(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private d(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 5
    invoke-static {p2, p1}, Lokhttp3/internal/http2/c;->d(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method private f(ISBI)Ljava/util/List;
    ...
    .line 5
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->d:Lokhttp3/internal/http2/b$a;
...
.method private g(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    invoke-direct {p0, p1, p4}, Lokhttp3/internal/http2/Http2Reader;->j(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 4
    invoke-direct {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Reader;->f(ISBI)Ljava/util/List;
...
.method private j(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private k(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private m(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private n(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-direct {p3}, Lokhttp3/internal/http2/h;-><init>()V
    ...
    :cond_9
    :goto_1
    invoke-virtual {p3, v2, v3}, Lokhttp3/internal/http2/h;->i(II)Lokhttp3/internal/http2/h;
    ...
    .line 11
    :cond_a
    invoke-interface {p1, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->settings(ZLokhttp3/internal/http2/h;)V
...
.method public b(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->h(Lokio/BufferedSource;)I
    ...
    invoke-static {v2, v0, v1, v3, p1}, Lokhttp3/internal/http2/c;->b(ZIIBB)Ljava/lang/String;
    ...
    .line 9
    :pswitch_0
    invoke-direct {p0, p2, v1, p1, v0}, Lokhttp3/internal/http2/Http2Reader;->o(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 12
    :pswitch_3
    invoke-direct {p0, p2, v1, p1, v0}, Lokhttp3/internal/http2/Http2Reader;->l(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 13
    :pswitch_4
    invoke-direct {p0, p2, v1, p1, v0}, Lokhttp3/internal/http2/Http2Reader;->n(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 14
    :pswitch_5
    invoke-direct {p0, p2, v1, p1, v0}, Lokhttp3/internal/http2/Http2Reader;->m(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V

    goto :goto_1

    .line 15
    :pswitch_6
    invoke-direct {p0, p2, v1, p1, v0}, Lokhttp3/internal/http2/Http2Reader;->k(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
...
.method public c(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-virtual {p0, v2, p1}, Lokhttp3/internal/http2/Http2Reader;->b(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    .line 3
    invoke-static {v0, p1}, Lokhttp3/internal/http2/c;->d(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    invoke-static {v5, v4}, Lokhttp3/internal/a;->q(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lokhttp3/internal/http2/c;->d(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
