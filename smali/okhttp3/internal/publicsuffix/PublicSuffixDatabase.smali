...
.method private e()V
    ...
    invoke-static {v0}, Lokio/h;->j(Ljava/io/InputStream;)Lokio/Source;

    move-result-object v0

    invoke-direct {v1, v0}, Lokio/f;-><init>(Lokio/Source;)V

    invoke-static {v1}, Lokio/h;->c(Lokio/Source;)Lokio/BufferedSource;
...
.method private f()V
    ...
    invoke-virtual {v2, v3, v4, v1}, Ltb/hv3;->p(ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
